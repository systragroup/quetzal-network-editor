...
## Features
* New Docs page
    * add new model specific docs page. under scenario _common/docs/ works like outputs .md.
...
* Import page:
    ...
    * can now rename a project [#597](https://github.com/systragroup/quetzal-network-editor/issues/597)

* Results:
    * add legendName to style.
    * add elevation (terrain) on result map if map layer is not light or dark.
    * can add GeoTiff to map (Raster Layer)
    * append styles (styles.json) generated by Transit microservice
    * add better markdown css (like github) for outputs aud doc .md
...
* Migration pipeline with versionning was added (only style.json (preset) for now)

### bug fixes
* remove params when unloading a project
* hideNaN was not working on non polygon layers
* do not show NaN NaN on Legend
* csv table was not showing All when selecting showAll.[#596](https://github.com/systragroup/quetzal-network-editor/issues/596)
* zip output uses the scenario name. even when changed. fixed. When renamaed. used the old name. fixed
...
* [7.2 CHANGELOG.md](https://github.com/systragroup/quetzal-network-editor/blob/master/changelogs/CHANGELOG-7.2.md) (2025-07-23 - 2025-12-04)
* [7.1 CHANGELOG.md](https://github.com/systragroup/quetzal-network-editor/blob/master/changelogs/CHANGELOG-7.1.md) (2025-05-08- 2025-07-16)
