  ...
  methods: {
    ...
    createPreset () {
      if (this.$refs.form.validate()) {
        ...
        const style = {
          name: cloneDeep(this.inputName),
          layer: cloneDeep(this.selectedLayer),
          displaySettings: cloneDeep(this.tempDisplaySettings),
          selectedFilter: cloneDeep(this.selectedFilter),
        }
        ...
        if (filteredCat.length < this.filteredCategory.length) {
          style.selectedCategory = cloneDeep(this.selectedCategory)
        }
